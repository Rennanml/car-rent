...
class ManageCustomerUseCaseTest {
    ...
    class CreateCustomer {
        ...
        void shouldCreateCustomerSuccessfully() {
            ...
            Customer result = manageCustomerUseCase.createCustomer("John Doe", VALID_CPF_STRING);
        ...
        void shouldThrowExceptionWhenCreatingWithInvalidCPF() {
            assertThatThrownBy(() -> manageCustomerUseCase.createCustomer("John Doe", INVALID_CPF_STRING))
        ...
        void shouldThrowExceptionWhenCreatingWithNullCPF() {
            assertThatThrownBy(() -> manageCustomerUseCase.createCustomer("John Doe", null))
                    .isInstanceOf(IllegalArgumentException.class);
        }
        ...
        void shouldThrowExceptionWhenCreatingWithExistingCPF() {
            ...
            assertThatThrownBy(() -> manageCustomerUseCase.createCustomer("John Doe", VALID_CPF_STRING))
    ...
    class UpdateCustomer {
        ...
        void shouldUpdateCustomerSuccessfully() {
            ...
            Optional<Customer> result = manageCustomerUseCase.updateCustomer(VALID_CPF_STRING, "John Updated");
        ...
        void shouldThrowExceptionWhenUpdatingWithInvalidInfo() {
            ...
            assertThatThrownBy(() -> manageCustomerUseCase.updateCustomer(VALID_CPF_STRING, ""))
                    .isInstanceOf(IllegalArgumentException.class)
        ...
        void shouldReturnEmptyWhenUpdatingNonExistentCustomer() {
            ...
            Optional<Customer> result = manageCustomerUseCase.updateCustomer(VALID_CPF_STRING, "Any Name");
    ...
    class DeleteCustomer {
        ...
        void shouldDeleteExistingCustomer() {
            ...
            boolean result = manageCustomerUseCase.deleteCustomer(VALID_CPF_STRING);
        ...
        void shouldReturnFalseWhenDeletingNonExistentCustomer() {
            ...
            boolean result = manageCustomerUseCase.deleteCustomer(VALID_CPF_UNFORMATTED);
    ...
    class FindCustomer {
        ...
        void shouldFindExistingCustomerByCpf() {
            ...
            Optional<Customer> result = manageCustomerUseCase.findCustomerByCpf(VALID_CPF_STRING);
        ...
        void shouldReturnEmptyWhenFindingNonExistentCustomerByCpf() {
            ...
            Optional<Customer> result = manageCustomerUseCase.findCustomerByCpf(VALID_CPF_UNFORMATTED);
        ...
        void shouldReturnAllCustomersSuccessfully() {
            ...
            List<Customer> result = manageCustomerUseCase.getAllCustomers();
